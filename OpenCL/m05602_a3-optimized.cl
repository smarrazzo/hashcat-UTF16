...
DECLSPEC void m05602m (PRIVATE_AS u32 *w0, PRIVATE_AS u32 *w1, PRIVATE_AS u32 *w2, PRIVATE_AS u32 *w3, const u32 pw_len, KERN_ATTR_FUNC_ESALT (netntlm_t), LOCAL_AS u32 *s_userdomain_buf, LOCAL_AS u32 *s_chall_buf)
{
  /**
...
DECLSPEC void m05602s (PRIVATE_AS u32 *w0, PRIVATE_AS u32 *w1, PRIVATE_AS u32 *w2, PRIVATE_AS u32 *w3, const u32 pw_len, KERN_ATTR_FUNC_ESALT (netntlm_t), LOCAL_AS u32 *s_userdomain_buf, LOCAL_AS u32 *s_chall_buf)
{
  /**
   * modifiers are taken from args
   */
...
KERNEL_FQ void m05602_m04 (KERN_ATTR_ESALT (netntlm_t))
{
  /**
   * modifier
   */
...
KERNEL_FQ void m05602_m08 (KERN_ATTR_ESALT (netntlm_t))
{
  /**
   * modifier
   */
...
KERNEL_FQ void m05602_m16 (KERN_ATTR_ESALT (netntlm_t))
{
  /**
   * modifier
   */
...
KERNEL_FQ void m05602_s04 (KERN_ATTR_ESALT (netntlm_t))
{
  /**
   * modifier
   */
...
KERNEL_FQ void m05602_s08 (KERN_ATTR_ESALT (netntlm_t))
{
  /**
   * modifier
   */
...
KERNEL_FQ void m05602_s16 (KERN_ATTR_ESALT (netntlm_t))
{
  /**
   * modifier
   */
