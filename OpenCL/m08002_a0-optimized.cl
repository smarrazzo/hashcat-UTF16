...
KERNEL_FQ void m08002_m04 (KERN_ATTR_RULES ())
{
  /**
   * modifier
   */
  ...
  for (u32 il_pos = 0; il_pos < IL_CNT; il_pos += VECT_SIZE)
  {
    ...
    apply_rules_vect_optimized_utf16le (pw_buf0, pw_buf1, pw_buf2, pw_buf3, pw_len, rules_buf, il_pos, w0_t, w1_t, w2_t, w3_t);
...
KERNEL_FQ void m08002_m08 (KERN_ATTR_RULES ())
{
}

KERNEL_FQ void m08002_m16 (KERN_ATTR_RULES ())
{
}

KERNEL_FQ void m08002_s04 (KERN_ATTR_RULES ())
{
  /**
   * modifier
   */
...
KERNEL_FQ void m08002_s08 (KERN_ATTR_RULES ())
{
}

KERNEL_FQ void m08002_s16 (KERN_ATTR_RULES ())
{
}
