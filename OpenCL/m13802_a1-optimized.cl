...
KERNEL_FQ void m13802_m04 (KERN_ATTR_ESALT (win8phone_t))
{
  /**
   * modifier
   */
  ...
  for (u32 il_pos = 0; il_pos < IL_CNT; il_pos += VECT_SIZE)
  {
    ...
    // we can always use pw_len here, since we add exactly the hash buffer size
    append_0x80_4x4 (w + 0, w + 4, w + 8, w + 12, pw_len ^ 3);
...
KERNEL_FQ void m13802_m08 (KERN_ATTR_ESALT (win8phone_t))
{
}

KERNEL_FQ void m13802_m16 (KERN_ATTR_ESALT (win8phone_t))
{
}

KERNEL_FQ void m13802_s04 (KERN_ATTR_ESALT (win8phone_t))
{
  /**
   * modifier
   */
...
KERNEL_FQ void m13802_s08 (KERN_ATTR_ESALT (win8phone_t))
{
}

KERNEL_FQ void m13802_s16 (KERN_ATTR_ESALT (win8phone_t))
{
}
