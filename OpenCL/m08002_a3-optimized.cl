...
DECLSPEC void m08002m (LOCAL_AS u32 *w_s1, LOCAL_AS u32 *w_s2, PRIVATE_AS u32 *w, const u32 pw_len, KERN_ATTR_FUNC_VECTOR ())
{
  /**
...
DECLSPEC void m08002s (LOCAL_AS u32 *w_s1, LOCAL_AS u32 *w_s2, PRIVATE_AS u32 *w, const u32 pw_len, KERN_ATTR_FUNC_VECTOR ())
{
  /**
   * modifiers are taken from args
   */
...
KERNEL_FQ void m08002_m04 (KERN_ATTR_VECTOR ())
{
  /**
   * base
   */
...
KERNEL_FQ void m08002_m08 (KERN_ATTR_VECTOR ())
{
  /**
   * base
   */
...
KERNEL_FQ void m08002_m16 (KERN_ATTR_VECTOR ())
{
  /**
   * base
   */
...
KERNEL_FQ void m08002_s04 (KERN_ATTR_VECTOR ())
{
  /**
   * base
   */
...
KERNEL_FQ void m08002_s08 (KERN_ATTR_VECTOR ())
{
  /**
   * base
   */
...
KERNEL_FQ void m08002_s16 (KERN_ATTR_VECTOR ())
{
  /**
   * base
   */
