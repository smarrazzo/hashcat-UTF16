...
KERNEL_FQ void m18202_m04 (KERN_ATTR_RULES_ESALT (krb5asrep_t))
{
  /**
   * modifier
   */
  ...
  for (u32 il_pos = 0; il_pos < IL_CNT; il_pos += VECT_SIZE)
  {
    ...
    kerb_prepare (w0, w1, w2, w3, out_len, checksum, digest, K2);
...
KERNEL_FQ void m18202_m08 (KERN_ATTR_RULES_ESALT (krb5asrep_t))
{
}

KERNEL_FQ void m18202_m16 (KERN_ATTR_RULES_ESALT (krb5asrep_t))
{
}

KERNEL_FQ void m18202_s04 (KERN_ATTR_RULES_ESALT (krb5asrep_t))
{
  /**
   * modifier
   */
...
KERNEL_FQ void m18202_s08 (KERN_ATTR_RULES_ESALT (krb5asrep_t))
{
}

KERNEL_FQ void m18202_s16 (KERN_ATTR_RULES_ESALT (krb5asrep_t))
{
}
