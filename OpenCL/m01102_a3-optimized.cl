...
DECLSPEC void m01102m (LOCAL_AS salt_t *s_salt_buf, PRIVATE_AS u32 *w, const u32 pw_len, KERN_ATTR_FUNC_VECTOR ())
{
  /**
...
DECLSPEC void m01102s (LOCAL_AS salt_t *s_salt_buf, PRIVATE_AS u32 *w, const u32 pw_len, KERN_ATTR_FUNC_VECTOR ())
{
  /**
   * modifiers are taken from args
   */
...
KERNEL_FQ void m01102_m04 (KERN_ATTR_VECTOR ())
{
  /**
   * base
   */
...
KERNEL_FQ void m01102_m08 (KERN_ATTR_VECTOR ())
{
  /**
   * base
   */
...
KERNEL_FQ void m01102_m16 (KERN_ATTR_VECTOR ())
{
  /**
   * base
   */
...
KERNEL_FQ void m01102_s04 (KERN_ATTR_VECTOR ())
{
  /**
   * base
   */
  ...
  m01102s (s_salt_buf, w, pw_len, pws, rules_buf, combs_buf, words_buf_r, tmps, hooks, bitmaps_buf_s1_a, bitmaps_buf_s1_b, bitmaps_buf_s1_c, bitmaps_buf_s1_d, bitmaps_buf_s2_a, bitmaps_buf_s2_b, bitmaps_buf_s2_c, bitmaps_buf_s2_d, plains_buf, digests_buf, hashes_shown, salt_bufs, esalt_bufs, d_return_buf, d_extra0_buf, d_extra1_buf, d_extra2_buf, d_extra3_buf, kernel_param, gid, lid, lsz);
}

KERNEL_FQ void m01102_s08 (KERN_ATTR_VECTOR ())
{
  /**
   * base
   */
...
KERNEL_FQ void m01102_s16 (KERN_ATTR_VECTOR ())
{
  /**
   * base
   */
