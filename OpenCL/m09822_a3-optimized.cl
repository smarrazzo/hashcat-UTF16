...
DECLSPEC void m09822m (LOCAL_AS u32 *S, PRIVATE_AS u32 *w0, PRIVATE_AS u32 *w1, PRIVATE_AS u32 *w2, PRIVATE_AS u32 *w3, const u32 pw_len, KERN_ATTR_FUNC_ESALT (oldoffice34_t))
{
  /**
...
DECLSPEC void m09822s (LOCAL_AS u32 *S, PRIVATE_AS u32 *w0, PRIVATE_AS u32 *w1, PRIVATE_AS u32 *w2, PRIVATE_AS u32 *w3, const u32 pw_len, KERN_ATTR_FUNC_ESALT (oldoffice34_t))
{
  /**
   * modifiers are taken from args
   */
...
KERNEL_FQ void m09822_m04 (KERN_ATTR_ESALT (oldoffice34_t))
{
  /**
   * base
   */
...
KERNEL_FQ void m09822_m08 (KERN_ATTR_ESALT (oldoffice34_t))
{
  /**
   * base
   */
...
KERNEL_FQ void m09822_m16 (KERN_ATTR_ESALT (oldoffice34_t))
{
  /**
   * base
   */
...
KERNEL_FQ void m09822_s04 (KERN_ATTR_ESALT (oldoffice34_t))
{
  /**
   * base
   */
...
KERNEL_FQ void m09822_s08 (KERN_ATTR_ESALT (oldoffice34_t))
{
  /**
   * base
   */
...
KERNEL_FQ void m09822_s16 (KERN_ATTR_ESALT (oldoffice34_t))
{
  /**
   * base
   */
