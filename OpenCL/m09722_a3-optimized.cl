...
DECLSPEC void m09722m (PRIVATE_AS u32 *w0, PRIVATE_AS u32 *w1, PRIVATE_AS u32 *w2, PRIVATE_AS u32 *w3, const u32 pw_len, KERN_ATTR_FUNC_ESALT (oldoffice01_t))
{
  /**
...
DECLSPEC void m09722s (PRIVATE_AS u32 *w0, PRIVATE_AS u32 *w1, PRIVATE_AS u32 *w2, PRIVATE_AS u32 *w3, const u32 pw_len, KERN_ATTR_FUNC_ESALT (oldoffice01_t))
{
  /**
   * modifiers are taken from args
   */
...
KERNEL_FQ void m09722_m04 (KERN_ATTR_ESALT (oldoffice01_t))
{
  /**
   * base
   */
...
KERNEL_FQ void m09722_m08 (KERN_ATTR_ESALT (oldoffice01_t))
{
  /**
   * base
   */
...
KERNEL_FQ void m09722_m16 (KERN_ATTR_ESALT (oldoffice01_t))
{
}

KERNEL_FQ void m09722_s04 (KERN_ATTR_ESALT (oldoffice01_t))
{
  /**
   * base
   */
...
KERNEL_FQ void m09722_s08 (KERN_ATTR_ESALT (oldoffice01_t))
{
  /**
   * base
   */
...
KERNEL_FQ void m09722_s16 (KERN_ATTR_ESALT (oldoffice01_t))
{
}
