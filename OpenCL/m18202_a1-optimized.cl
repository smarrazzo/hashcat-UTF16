...
DECLSPEC void kerb_prepare (PRIVATE_AS const u32 *w0, PRIVATE_AS const u32 *w1, PRIVATE_AS const u32 *w2, PRIVATE_AS const u32 *w3, const u32 pw_len, PRIVATE_AS const u32 *checksum, PRIVATE_AS u32 *digest, PRIVATE_AS u32 *K2)
{
  /**
   * pads
   */
...
KERNEL_FQ void m18202_m04 (KERN_ATTR_ESALT (krb5asrep_t))
{
  /**
   * modifier
   */
  ...
  {
    const u32x pw_r_len = pwlenx_create_combt (combs_buf, il_pos) & 127;

    const u32x pw_len = (pw_l_len + pw_r_len) & 127;
    ...
    kerb_prepare (w0, w1, w2, w3, pw_len, checksum, digest, K2);
...
KERNEL_FQ void m18202_m08 (KERN_ATTR_ESALT (krb5asrep_t))
{
}

KERNEL_FQ void m18202_m16 (KERN_ATTR_ESALT (krb5asrep_t))
{
}

KERNEL_FQ void m18202_s04 (KERN_ATTR_ESALT (krb5asrep_t))
{
  /**
   * modifier
   */
...
KERNEL_FQ void m18202_s08 (KERN_ATTR_ESALT (krb5asrep_t))
{
}

KERNEL_FQ void m18202_s16 (KERN_ATTR_ESALT (krb5asrep_t))
{
}
