...
DECLSPEC void append_block8_optimized_utf16le (const u32 offset, PRIVATE_AS u32 *buf0, PRIVATE_AS u32 *buf1, PRIVATE_AS u32 *buf2, PRIVATE_AS u32 *buf3, PRIVATE_AS const u32 *src_l0, PRIVATE_AS const u32 *src_l1, PRIVATE_AS const u32 *src_l2, PRIVATE_AS const u32 *src_l3, PRIVATE_AS const u32 *src_r0, PRIVATE_AS const u32 *src_r1, PRIVATE_AS const u32 *src_r2, PRIVATE_AS const u32 *src_r3);
...
#endif // INC_RP_OPTIMIZED_H_UTF16LE
