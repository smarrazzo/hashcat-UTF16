...
DECLSPEC void m01772m (PRIVATE_AS u32 *w, const u32 pw_len, KERN_ATTR_FUNC_VECTOR ())
{
  /**
...
DECLSPEC void m01772s (PRIVATE_AS u32 *w, const u32 pw_len, KERN_ATTR_FUNC_VECTOR ())
{
  /**
   * modifiers are taken from args
   */
...
KERNEL_FQ void m01772_m04 (KERN_ATTR_VECTOR ())
{
  /**
   * base
   */
  ...
  m01772m (w, pw_len, pws, rules_buf, combs_buf, words_buf_r, tmps, hooks, bitmaps_buf_s1_a, bitmaps_buf_s1_b, bitmaps_buf_s1_c, bitmaps_buf_s1_d, bitmaps_buf_s2_a, bitmaps_buf_s2_b, bitmaps_buf_s2_c, bitmaps_buf_s2_d, plains_buf, digests_buf, hashes_shown, salt_bufs, esalt_bufs, d_return_buf, d_extra0_buf, d_extra1_buf, d_extra2_buf, d_extra3_buf, kernel_param, gid, lid, lsz);
}

KERNEL_FQ void m01772_m08 (KERN_ATTR_VECTOR ())
{
  /**
   * base
   */
...
KERNEL_FQ void m01772_m16 (KERN_ATTR_VECTOR ())
{
  /**
   * base
   */
...
KERNEL_FQ void m01772_s04 (KERN_ATTR_VECTOR ())
{
  /**
   * base
   */
  ...
  m01772s (w, pw_len, pws, rules_buf, combs_buf, words_buf_r, tmps, hooks, bitmaps_buf_s1_a, bitmaps_buf_s1_b, bitmaps_buf_s1_c, bitmaps_buf_s1_d, bitmaps_buf_s2_a, bitmaps_buf_s2_b, bitmaps_buf_s2_c, bitmaps_buf_s2_d, plains_buf, digests_buf, hashes_shown, salt_bufs, esalt_bufs, d_return_buf, d_extra0_buf, d_extra1_buf, d_extra2_buf, d_extra3_buf, kernel_param, gid, lid, lsz);
}

KERNEL_FQ void m01772_s08 (KERN_ATTR_VECTOR ())
{
  /**
   * base
   */
...
KERNEL_FQ void m01772_s16 (KERN_ATTR_VECTOR ())
{
  /**
   * base
   */
