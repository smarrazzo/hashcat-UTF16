...
KERNEL_FQ void m13502_m04 (KERN_ATTR_RULES_ESALT (pstoken_t))
{
  /**
   * modifier
   */
  ...
  for (u32 il_pos = 0; il_pos < IL_CNT; il_pos += VECT_SIZE)
  {
    ...
    const u32 r = (salt_len - pc_offset4) + out_len;
...
KERNEL_FQ void m13502_m08 (KERN_ATTR_RULES_ESALT (pstoken_t))
{
}

KERNEL_FQ void m13502_m16 (KERN_ATTR_RULES_ESALT (pstoken_t))
{
}

KERNEL_FQ void m13502_s04 (KERN_ATTR_RULES_ESALT (pstoken_t))
{
  /**
   * modifier
   */
...
KERNEL_FQ void m13502_s08 (KERN_ATTR_RULES_ESALT (pstoken_t))
{
}

KERNEL_FQ void m13502_s16 (KERN_ATTR_RULES_ESALT (pstoken_t))
{
}
