...
KERNEL_FQ void m05602_mxx (KERN_ATTR_ESALT (netntlm_t))
{
  /**
   * modifier
   */
  ...
  md4_update_global (&ctx10, pws[gid].i, pws[gid].pw_len);
...
KERNEL_FQ void m05602_sxx (KERN_ATTR_ESALT (netntlm_t))
{
  /**
   * modifier
   */
