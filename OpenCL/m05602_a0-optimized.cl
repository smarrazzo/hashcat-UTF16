...
KERNEL_FQ void m05602_m04 (KERN_ATTR_RULES_ESALT (netntlm_t))
{
  /**
   * modifier
   */
  ...
  for (u32 il_pos = 0; il_pos < IL_CNT; il_pos += VECT_SIZE)
  {
    ...
    const u32x out_len = apply_rules_vect_optimized_utf16le (pw_buf0, pw_buf1, pw_buf2, pw_buf3, pw_len, rules_buf, il_pos, w0_t, w1_t, w2_t, w3_t);
...
KERNEL_FQ void m05602_m08 (KERN_ATTR_RULES_ESALT (netntlm_t))
{
}

KERNEL_FQ void m05602_m16 (KERN_ATTR_RULES_ESALT (netntlm_t))
{
}

KERNEL_FQ void m05602_s04 (KERN_ATTR_RULES_ESALT (netntlm_t))
{
  /**
   * modifier
   */
...
KERNEL_FQ void m05602_s08 (KERN_ATTR_RULES_ESALT (netntlm_t))
{
}

KERNEL_FQ void m05602_s16 (KERN_ATTR_RULES_ESALT (netntlm_t))
{
}
