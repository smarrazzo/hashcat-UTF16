...
KERNEL_FQ void m12802_init (KERN_ATTR_TMPS_ESALT (pbkdf2_sha256_tmp_t, pbkdf2_sha256_t))
{
  /**
   * base
   */
  ...
  md4_update_global (&md4_ctx, pws[gid].i, pws[gid].pw_len);
...
KERNEL_FQ void m12802_loop (KERN_ATTR_TMPS_ESALT (pbkdf2_sha256_tmp_t, pbkdf2_sha256_t))
{
  const u64 gid = get_global_id (0);
...
KERNEL_FQ void m12802_comp (KERN_ATTR_TMPS_ESALT (pbkdf2_sha256_tmp_t, pbkdf2_sha256_t))
{
  /**
   * base
   */
