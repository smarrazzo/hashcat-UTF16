...
DECLSPEC void m13502m (PRIVATE_AS u32 *w0, PRIVATE_AS u32 *w1, PRIVATE_AS u32 *w2, PRIVATE_AS u32 *w3, const u32 pw_len, KERN_ATTR_FUNC_ESALT (pstoken_t))
{
  /**
...
DECLSPEC void m13502s (PRIVATE_AS u32 *w0, PRIVATE_AS u32 *w1, PRIVATE_AS u32 *w2, PRIVATE_AS u32 *w3, const u32 pw_len, KERN_ATTR_FUNC_ESALT (pstoken_t))
{
  /**
   * modifiers are taken from args
   */
...
KERNEL_FQ void m13502_m04 (KERN_ATTR_ESALT (pstoken_t))
{
  /**
   * base
   */
...
KERNEL_FQ void m13502_m08 (KERN_ATTR_ESALT (pstoken_t))
{
  /**
   * base
   */
...
KERNEL_FQ void m13502_m16 (KERN_ATTR_ESALT (pstoken_t))
{
  /**
   * base
   */
...
KERNEL_FQ void m13502_s04 (KERN_ATTR_ESALT (pstoken_t))
{
  /**
   * base
   */
...
KERNEL_FQ void m13502_s08 (KERN_ATTR_ESALT (pstoken_t))
{
  /**
   * base
   */
...
KERNEL_FQ void m13502_s16 (KERN_ATTR_ESALT (pstoken_t))
{
  /**
   * base
   */
