...
KERNEL_FQ void m07502_m04 (KERN_ATTR_ESALT (krb5pa_t))
{
  /**
   * modifier
   */
  ...
  for (u32 il_pos = 0; il_pos < IL_CNT; il_pos += VECT_SIZE)
  {
    ...
    kerb_prepare (w0, w1, w2, w3, pw_len, checksum, digest);
...
KERNEL_FQ void m07502_m08 (KERN_ATTR_ESALT (krb5pa_t))
{
}

KERNEL_FQ void m07502_m16 (KERN_ATTR_ESALT (krb5pa_t))
{
}

KERNEL_FQ void m07502_s04 (KERN_ATTR_ESALT (krb5pa_t))
{
  /**
   * modifier
   */
...
KERNEL_FQ void m07502_s08 (KERN_ATTR_ESALT (krb5pa_t))
{
}

KERNEL_FQ void m07502_s16 (KERN_ATTR_ESALT (krb5pa_t))
{
}
