...
KERNEL_FQ void m01001_m04 (KERN_ATTR_RULES ())
{
  /**
   * modifier
   */
  ...
  for (u32 il_pos = 0; il_pos < IL_CNT; il_pos += VECT_SIZE)
  {
    ...
    const u32x out_len = apply_rules_vect_optimized_utf16le (pw_buf0, pw_buf1, pw_len, rules_buf, il_pos, w0, w1);

    append_0x80_2x4_VV (w0, w1, out_len);
    u32x out_len2 = make_real_utf16le (w1, w2, w3);
    out_len2 += make_real_utf16le (w0, w0, w1);
...
KERNEL_FQ void m01001_m08 (KERN_ATTR_RULES ())
{
}

KERNEL_FQ void m01001_m16 (KERN_ATTR_RULES ())
{
}

KERNEL_FQ void m01001_s04 (KERN_ATTR_RULES ())
{
  /**
   * modifier
   */
  ...
  for (u32 il_pos = 0; il_pos < IL_CNT; il_pos += VECT_SIZE)
  {
    ...
    make_real_utf16le (w1, w2, w3);
    make_real_utf16le (w0, w0, w1);
...
KERNEL_FQ void m01001_s08 (KERN_ATTR_RULES ())
{
}

KERNEL_FQ void m01001_s16 (KERN_ATTR_RULES ())
{
}
