...
KERNEL_FQ void m31302_mxx (KERN_ATTR_BASIC ())
{
  /**
   * modifier
   */
  ...
  md4_update_global (&ctx0a, pws[gid].i, pws[gid].pw_len);
  ...
  for (u32 il_pos = 0; il_pos < IL_CNT; il_pos++)
  {
    ...
    md4_update_global (&ctx0, combs_buf[il_pos].i, combs_buf[il_pos].pw_len);
...
KERNEL_FQ void m31302_sxx (KERN_ATTR_BASIC ())
{
  /**
   * modifier
   */
