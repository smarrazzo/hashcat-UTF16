#hashcat.exe -a 0 -m 137 ..\test\test_rules\h.txt ..\test\test_rules\dico.txt -r ..\test\test_rules\rules.txt --potfile-disable -O --encoding-to=utf16le -u1 -n1 -Y 1 --backend-vector=1  --force
...
for word in words:
    try:
        ...
        f.write(base64.b64encode(h.digest()).decode('utf-8')+'\n')
        ff.write(base64.b64encode(h.digest()).decode('utf-8')+word+'\n')
