...
static const char *HASH_NAME      = "Episerver 6.x >= .NET 4 Full UTF16LE";
...
static const char *ST_HASH        = "$episerver$*1*NDg1NTIz*8BFCg/YJBAuZs/wjbH3OWKe69BLr5Lao26ybpnD48Zk";
